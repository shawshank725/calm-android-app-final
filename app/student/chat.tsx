...
export default function Chat() {
  ...
  }, [newMessage, studentInfo, participantId, isSending]);
  ...
  useEffect(() => {
    if (studentInfo.registration && participantId) {
      loadChatMessages();
  ...
  }, [studentInfo.registration, participantId]);
  ...
  const loadChatMessages = async () => {
    try {
      if (!participantId || !studentInfo.registration) return;
